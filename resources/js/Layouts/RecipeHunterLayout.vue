...
<template >
            ...
            <div class="navbar bg-base-100">
                ...
                <div class="navbar-end  ">
                    <div class="form-control hidden lg:flex mr-2">
                        ...
                        <input type="text" placeholder="Search" class="input input-bordered border-2 input-accent bg-gradient-to-r from-lemon-20 to-green-20 rounded-full" />
                    </div>
    ...
    <!-- <footer>
            <div class="footer items-center p-4 bg-neutral absolute bottom-0 ">
