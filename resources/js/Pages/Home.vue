...
<template>
    <main>
        <section class="absolute w-full h-xl">
            <RecipeHunterLayout />
            <div class="container mx-auto px-4 w-full h-full mt-5">
                <div class=" flex items-center justify-center px-4">
                    <mainCarousel />
                    <div id="indicators-carousel" class="relative w-full " data-carousel="static">
                        <!-- Carousel wrapper -->
                        <div class="relative h-56 overflow-hidden sm:rounded-[20px] rounded-[20px] md:h-[500px]">
                            <!-- Item 1 -->
                                    ...
                                    <!-- <div class="absolute  flex flex:lg bottom-10 left-10 ">
                                        ...
                                        <div class="flex flex-row  px-10 ">
                                            <div class="rounded-[10px]">
                                                <img src="assets/images/taco.png" alt="Your Image" class="object-contain">
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <img src="assets/images/image-102.png"
                                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                    alt="...">
                            </div>
                            <!-- Item 3 -->
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <img src="assets/images/image-103.png"
                                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                    alt="...">
                            </div>
                            <!-- Item 4 -->
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <img src="assets/images/image-104.png"
                                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                    alt="...">
                            </div>
                            <!-- Item 5 -->
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <img src="assets/images/image-101.png"
                                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                    alt="...">
                            </div>
                        </div>
