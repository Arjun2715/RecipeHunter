        ...
        <section class="flex flex-col w-full">
            <div class="container mx-auto px-4 mt-20">
                ...
                >
                            ...
                            <div class="flex flex-col">
                                ...
                                >
                                    ...
                                    <div class="hidden flex-row lg:flex">
                                        ...
                                        <div
                                            class="flex-col justify-start text-white px-4"
                                        >
                                            <div
                                            ...
                                            <h1
                                                class="flex justify-start md:text-2xl lg:text-6xl font-semibold"
                                            >
                                                {{ item.title }}
                                            </h1>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <label class="align-bottom"
                                                        >Favourite</label
                                                    >
                                                </a>
                                            </div>
                                            <div
                                                class="w-auto max-w-screen-lg text-left"
                                            >
                                                {{ item.description }}
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        class="hidden md:flex flex-row justify-end"
                                    >
                                        <div
                                            class="p-2 flex flex-col justify-end text-white"
                                        >
                                            <Pagination
                                        ...
                                        <div
                                            class="p-2 flex flex-col justify-end"
                                        >
                                            <Link
                                                href="/viewrecipe"
                                                meathod="get"
                    ...
                    <template #addons>
                        <navigation
                            class="h-20 dark:bg-gray-200 rounded-full"
                        />
                    </template>
                </carousel>
                ...
                <div class="flex flex-col lg:mt-[50px] md:mt-[30px] mt-[20px]">
                    ...
                    <div
                        v-for="rece in data.recentlyUpdated"
