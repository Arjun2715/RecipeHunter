    ...
    <nav class="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-3">
        <div class="container px-4 mx-auto flex items-center justify-between">
            ...
            <div class="flex px-2">
                ...
                <Link href="/register" class="btn flex-1 w-32 rounded-r-full border-none shadow hover:shadow-lg">
                SignUp
                </Link>
            </div>
        </div>
                        ...
                        <div class="rounded-t mb-0 px-6 py-6">
                            <form>
                                <div class="relative w-full mb-3">
                                    ...
                                    <input v-model="emailValue" type="email" id="email"
                                ...
                                <div class="text-center mt-6">
                                    <Link
                                        ...
                                        style="transition: all 0.15s ease 0s" href="/login" method="post" as="button"
                                        type="button" :data="{
                                                email: emailValue,
