                ...
                <div class="container mx-auto px-4 w-full h-full">
                    ...
                    >
                        ...
                        <div class="grow flex-1 dropdown dropdown-end py-1">
                            <label
                                tabindex="0"
                                class="btn w-full inline-flex items-center py-2.5 px-3 text-sm font-medium text-gray-500 dark:text-white bg-green border-none rounded-full border-lemon hover:bg-green-80"
                                ><span></span>Sort</label
                            >
                            <ul
                                tabindex="0"
                                class="dropdown-content menu p-2 shadow bg-white dark:bg-gray-600 dark:text-white rounded-box w-52"
                    ...
                    <div class="h-auto">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="card card-side bg-white dark:bg-gray-600 h-48 overflow-hidden"
                                    >
                                        <img
                                            class=" "
                                            :src="item.image"
                                        ...
                                        <div class="card-body p-2">
                                            <h2
                                                class="card-title text-gray-800 dark:text-white text-xl"
                                            >
                                                {{ item.title }}
                                            </h2>
