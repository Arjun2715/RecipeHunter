...
<template>
    ...
    >
        <div class="container px-4 mx-auto flex items-center justify-between">
            ...
            >
                <a
                    class="text-xl font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-gray-500"
                    href="#"
                    >Recipe Hunter</a
                >
            </div>
            <div class="flex px-2">
                <router-link
                    to="/login"
                    class="btn w-30 rounded-l-full border-none shadow hover:shadow-lg"
                    @click="goToLogin"
                >
                    Login
                </router-link>
                <router-link
                    to="register"
                    class="btn w-30 rounded-r-full btn-active bg-gradient-to-r from-lemon to-green border-none shadow hover:shadow-lg"
                    @click="goToSignup"
                >
                    Sign Up
                </router-link>
